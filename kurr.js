...
const dtod = "6289695073357@s.whatsapp.net"
const otod = "6289695073357@s.whatsapp.net"
// STICKER WM
...
const fakegroup = (teks) => {
            kurr.sendMessage(from, teks, text, {
                quoted: {
                    key: {
                        fromMe: false,
                        participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289695073357-1604595598@g.us" } : {})
                    },
                    message: {
                        "imageMessage": {
...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© 「  NEKELLH4XOR 🔥 」_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6289695073357-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/J9CRXS0KuDsLaH68uvuRcU', "groupName": `「  NEKELLH4XOR 🔥 」`, "footerText": "*_© 「  NEKELLH4XOR 🔥 」 v.3.0_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		message: {
			"productMessage": {
				"product": {
					"productImage":{
						"mimetype": "image/jpeg",
						"jpegThumbnail": "./media/thumb.jpg" //Gambarnye
					},
					"title": `HACKED BY UNKNOWNNEKELL404.`, //Kasih namalu 
...
const fvid = {
	 ...
	 { remoteJid: "6289695073357-1613049930@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `${tampilUcapan} ${pushname}`,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "6289695073357-1616169743@g.us",
...
const daftar3 = [{buttonId: `${prefix}verify`,buttonText: {displayText: '「  D A F T A R  C O R N F A K E  」',},type: 1,},]
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© 「  NEKELLH4XOR 🔥 」_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
        ...
        const sendWebp = async(from, url) => {
	        ...
	        const vcard = 'BEGIN:VCARD\n' + 'VERSION:3.0\n' + 'FN:' + nama + '\n' + `ORG:Developer 「  NEKELLH4XOR 🔥 」 v.3.0\n` + 'TEL;type=CELL;type=VOICE;waid=' + nomor + ':+' + nomor + '\n' + 'END:VCARD'
		...
		const reply = (teks) => {
			kurr.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: `${jmn} - ${week}  - ${calender}`,body:"「  NEKELLH4XOR 🔥 」",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/p/6349482305092740/6289695073357`}}})
		}
...
if(budy.includes('nekell')){
kurr.sendMessage(from, "hayo ngomongin owner gua ya", text)
kurr.sendMessage("6289695073357@s.whatsapp.net", `bang di gosipin Ama wa.me/${sender} Labrak Bang`, text)
...
reply(String(e))
			...
			for (let anju of vien){
				if (budy === anju){
					...
					kurr.sendMessage(from, result, audio, { mimetype: 'audio/mp4', duration: 9999999999999999999999999999999, ptt: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true}})
					}
			}
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 2500) {
        ...
        kurr.groupRemove(from, [kic]).catch((e) => { reply(`WKWKWK MAMPUS DI KICK🗿`) })
           ...
           if (budy.includes("https://","chat.whatsapp.com/","http://",".","www")) {
        	if (!mek.key.fromMe){
				if (!isGroup) return
				...
				var kic = `${sender.split("@")[0]}@s.whatsapp.net`
				reply('Udah tau antilink masih ae batu, Auto kick!')
...
if (isCmd && !isOwner) antiSpam.addFilter(from)
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`Hy Iam CornFake👹 | Spam/Vc/Call/Chatt Auto Blok! Ini Nomer Bot Jika Ingin Bertanya Silahkan Hubungi Owner!`).catch((_)=>_);
...
kurr.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]}})
 ...
 footerText: '*_© 「 の C O R N  F A K E あ」_*',
 description: `Hai @${stod.split('@')[0]}\nSaya Adalah CornFake Bot\nIni Simpel Menu Ya Biar\nGa Ribet Dan Gampang Untuk Diakses.\n\n「  JANGAN LUPA DONASI🏴‍☠️  」\n_©Created By NekellH4xor🔥_`,
 sections: [
                     {
...
_書 ${prefix}nano [ _nama file_ ]_             
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`${prefix}donasi`,buttonText:{displayText:'「  D O N A S I  」'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
_書 ${prefix}gift_               
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`${prefix}donasi`,buttonText:{displayText:'「  NEKELLH4XOR 🔥 」'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
_書 ${prefix}totag [ _reply media_ ]_        
 ...
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」 ゑ_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`${prefix}donasi`,buttonText:{displayText:'「  D O N A S I   」'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
_書 ${prefix}smeme _[ _nama|author_ ]_
_書 ${prefix}dadu_
...
*Sebenernya masih banyak game menu,ya cuma gw males ngetik hehe:v*
_©Created By NekellH4xor 🔥_ `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`${prefix}donasi`,buttonText:{displayText:'「  D O N A S I   」'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
...
Baca artikel detiknews, "Surat Al-Isra Ayat 32, Tentang Larangan Mendekati Zina"`
  if (!isOwner && !isPremium && !mek.key.fromMe) return reply(ini_txt)             
boks = Date.now();
...
case 'meme':
              ...
              buttonsMessage = {footerText:'_©「  NEKELLH4XOR 🔥 」_', imageMessage: imageMsg,
...
JIKA MAU GRATIS
JOIN GRUP
GC 1: https://chat.whatsapp.com/J9CRXS0KuDsLaH68uvuRcU`
...
_ℒ⃝👨‍💻 Name Creator : 「  NEKELLH4XOR 🔥 」_

*BOT INI BERJALAN DI*
WEBSITE HEROKU DAN MEMAKAN BANYAK KUOTA
SILAHKAN DONASI AGAR BOT ALWAYS ON 24 JAM.
`
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`${prefix}store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`${prefix}speed`,buttonText:{displayText:'SPEED BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
case 'catlog': 
                ...
                nama = ' ゑwelcome to NekellH4xor storeゑ '
       ownerJid = "6289695073357@s.whatsapp.net"
                nomor = 1
                stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
       menunya = `*NekellH4xor Store Melayani Jasa*

「  KEPENTINGAN BOT  」
*Jasa Run Bot 24Jam (Sc Gw/Lu Bebas)*
*Jasa Sewa Bot (Untuk kepentingan pribadi/grup)*

「  PEMBUATAN LOGO  」
*_List Logo!_*
*LOGO UNTUK JB*
*LOGO UNTUK BOT*
*LOGO UNTUK GRUP/PRIBADI*
*LOGO STORE*
*LOGO UNTUK ESPORT/TEAM GAME LAIN NYA!*
*UNTUK CONTOH ATAU UNTUK MENTAHAN BISA REQUEST SESUKA HATI ANDA.*
*_JIKA DI ATAS TIDAK ADA YANG ANDA CARI, SILAHKAN HUBUNGI OWNER BOT_*
...
INFO : JASA STORE NEKELLH4XOR HANYA ADA
SATU YAITU INI, JADI JIKA ADA YANG MEMBAWA
NAMA STORE NEKELLH4XOR SELAIN INI ITU
TANDA NYA BUKAN NEKELLH4XOR DAN SUDAH
DI LUAR TANGGUNG JAWAB OWNER KU!

LAINNYA : _JIKA DI ATAS TIDAK ADA YANG KALIAN CARI,MAKA SEGERA HUBUNGI OWNER BOT!_

MINAT KETIK .owner
ATAU HUBUNGI wa.me//6289695073357`
if(menuall == false){
   //Masih langka
...
MINAT KLIK ORDER
 ...
 `
sendButLocation(from, `${menu}`, "*STORE MENU*", {jpegThumbnail:store1,name:""}, [{buttonId:`${prefix}order`,buttonText:{displayText:'CLICK HERE FOR ORDER'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
*NekellH4xor Menyediakan Jasa Install Bot*
_platform heroku only_
...
JANGAN LUPA JOIN GC : https://chat.whatsapp.com/J9CRXS0KuDsLaH68uvuRcU
*「 CORNFAKE-BOT 」*`
gbutsan = [
...
GC BOT OFFICIAL:
https://chat.whatsapp.com/J9CRXS0KuDsLaH68uvuRcU
GC BOT PARTNER:
https://chat.whatsapp.com/B7qJrXS6SLRA5j8YnHv3aj`
reply(ini_txt)
break
...
//Sampai sini
case 'jadibot':
    reply(`MAU JADIBOT? BELI JASA RUN BOT AJ KETIK .owner LALU CHAT BISA SET BOT SEMAU LO`)
    break
    case 'order':
...
SILAHKAN KLIK LANJUT
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:store1,name:""}, [{buttonId:`${prefix}qriss`,buttonText:{displayText:'LANJUT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
...
ini_list.push({
"displayName": `Developer 「  NEKELLH4XOR 🔥 」`,
...
case 'script':
case 'sc':
reply(`SC YA?YAHAHAH USAHA BANG,BELI AJA DI ORANG,ATAU GA BELI AJA DI GW TERUS KLIK .store\nSABAR BANG INI GAJIAN BUAT LU SEMUA AOWKWOWKWO🗿🤙`)
break
case 'asupan':
...
Di Bawah       
 ...
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:store1,name:""}, [{buttonId:`${prefix}gopay`,buttonText:{displayText:'GOPAY'},type:1},{buttonId:`${prefix}dana`,buttonText:{displayText:'DANA'},type:1},{buttonId:`${prefix}qriss`,buttonText:{displayText:'QRIS ALL PAY'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
...
DAN KIRIM BUKTI TF KE KONTAK TERSEBUT
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:dana,name:""}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'Lanjut Kirim Bukti Tf'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'gopay':
menu = `NO GOPAY:
081224413305
A/N NEKELLH4XOR-STORE
LALU KLIK TOMBOL DI BAWAH 
DAN KIRIM BUKTI TF KE KONTAK TERSEBUT
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:gopay,name:""}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'Lanjut Kirim Bukti Tf'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break        
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `「 の C O R N  F A K E あ」`,
							"hydratedButtons": [
								{
									"quickreplyButton": {
...
case 'blackpink':
                ...
                if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length == 0) return reply(`Example: ${prefix + command} NEKELL HAXOR`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=${lolkey}&text=${ini_txt}`).then((gambar) => {
                        kurr.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `JANGAN LUPA DONASI MEKK`, quoted : ftrol})
                    })
                    break
                case 'pornhub':
                case 'glitch':
...
case 'matrix':
                ...
                break
					case 'restart':
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
reply(`_Restarting 「 の C O R N  F A K E あ」_`)
exec(`cd &&  node index`)
sleep(4000)
reply('Sukses')
break
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`「 の C O R N  F A K E あ」`}, MessageType.location)
...
if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
            ...
            uhuy = await getBuffer(res.result)
            kurr.sendMessage(from, uhuy, video, { mimetype: 'video/mp4', quoted: mek }
            })
            }else {
...
var nn = body.slice(9)
           ...
           case 'fitnahpc':
            ...
            case 'tagall': case 'infoall':
                ...
                let tekss = `══✪〘 *👥 PARA BEBAN KELUARGA!* 〙✪══\n\n➲ *Message : ${q ? q : 'Nothing'}*\n\n`
		      	for (let mem of participants) {
		            tekss += `࿃➡️ @${mem.id.split('@')[0]}\n`
				}
                tekss += `\n⋙ *${botname}* ⋘`
                kurr.sendMessage(from, { text: tekss, mentions: participants.map(a => a.id) }, { quoted: m })
            break
            case 'hidetag':
            case 'h':
          if (!isOwner && !mek.key.fromMe) return reply(`Khusus Owner Om`)
            ...
            if (!isGroup) return reply(mess.only.group)
              ...
              if (!isBotGroupAdmins) return reply(`Jdiin Admin Dlu Bjir🗿`)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY 「 の C O R N  F A K E あ」`)
...
Link : ${get_resultP.audio}
            ...
            "mediaUrl": "https://facebook.com/nekellganss",
            "thumbnail": fs.readFileSync("./media/logonya2.jpeg"),
            "sourceUrl": "https://cirebonxploit.tech"
...
`
buttons = [{buttonId:`${prefix}ytmp3 ${res.all[0].url}`,buttonText:{displayText:'🎵AUDIO'},type:1},{buttonId:`${prefix}ytmp4 ${res.all[0].url}`,buttonText:{displayText:'MP4📰'},type:1}]
...
break
			...
			case 'speed':
			case 'ping':
ini_txt = `CornFake-Bot Merespon Dalam ${latensyi.toFixed(4)} DETIK
`
reply(ini_txt)
break
				case 'return':
...
break
 ...
 `
sendButLocation(from, `${menu}`, "*_© 「  NEKELLH4XOR 🔥 」_*", {jpegThumbnail:ofrply3,name:""}, [{buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER THIS BOT'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Ohayoo ${pushname}, ${tampilUcapan}
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer 「  NEKELLH4XOR 🔥 」",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6289695073357"}}})
	}
    }
    }
    }
